...
export default function BudgetForm({ onAdd }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4 mb-6 animate__animated animate__fadeIn">
      ...
      <div className="flex bg-gray-100 p-1 rounded-lg w-full md:w-fit self-start">
        <button
          type="button"
          onClick={() => setTipo("Entrada")}
          className={`flex-1 flex items-center justify-center gap-2 px-4 py-1.5 rounded-md text-sm font-medium transition-all ${tipo === "Entrada" ? "bg-green-100 text-green-700 shadow-sm" : "text-gray-500 hover:text-gray-700"
            }`}
        >
        ...
        <button
          ...
          className={`flex-1 flex items-center justify-center gap-2 px-4 py-1.5 rounded-md text-sm font-medium transition-all ${tipo === "Saída" ? "bg-red-100 text-red-700 shadow-sm" : "text-gray-500 hover:text-gray-700"
            }`}
        >
      ...
      <div className="flex flex-col md:flex-row gap-3">
        <input
          ...
          className="border rounded-lg px-3 py-2 w-full md:w-1/2 focus:ring-2 focus:ring-blue-100 outline-none"
        />
        <input
          type="number"
          placeholder="Valor (R$)"
          ...
          className="border rounded-lg px-3 py-2 w-full md:w-1/4 focus:ring-2 focus:ring-blue-100 outline-none"
        />
        <button
          type="submit"
